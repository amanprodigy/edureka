...
class Command(BaseCommand):
    help = 'Sends an email reminder to users registered more \
            than n days that are not enrolled in any courses yet.'
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            message = 'Dear {}, \n We noticed that you did not enroll in any courses yet. Please do'.format(user.first_name)
